...
`douyin-standard-live-room-top5-ads` 是面向 Codex 的抖音本地生活投放自动化 Skill。按官号近 7 日 GMV Top5 与 VV Top5 参数化直播间短视频计划，默认预演，提交后回读。
...
将本仓库目录复制到 Codex 的 Skill 目录，目录名保持为 `douyin-standard-live-room-top5-ads`。参数和执行边界见 [SKILL.md](SKILL.md)。
